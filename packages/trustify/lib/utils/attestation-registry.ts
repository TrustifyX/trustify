...
const TRUSTIFY_SCHEMAS_PREFIX_URI = "https://trustify.id/definitions/schemas/0.0.1"
const TRUSTIFY_PROCESSES_PREFIX_URI = "https://trustify.id/definitions/processes"
...
function instantiate(
  ...
  return {
    ...
    schema: `${TRUSTIFY_SCHEMAS_PREFIX_URI}/${attestationName}`,
...
const allAttestations = new Map<string, AttestationDefinition>([
  [
    ...
    instantiate(
      KYCAML_ATTESTATION,
      `${TRUSTIFY_PROCESSES_PREFIX_URI}/kycaml/0.0.1/usa`
    )
  ],
  [
    KYBPAML_ATTESTATION,
    instantiate(
      KYBPAML_ATTESTATION,
      `${TRUSTIFY_PROCESSES_PREFIX_URI}/kybpaml/0.0.1/usa`
    )
  ],
  [
    ...
    instantiate(
      ENTITY_ACC_INV_ATTESTATION,
      `${TRUSTIFY_PROCESSES_PREFIX_URI}/kycaml/0.0.1/generic--usa-entity-accinv-all-checks`
    )
  ],
  [
    ...
    instantiate(
      INDIV_ACC_INV_ATTESTATION,
      `${TRUSTIFY_PROCESSES_PREFIX_URI}}/kycaml/0.0.1/generic--usa-indiv-accinv-all-checks`
    )
  ],
