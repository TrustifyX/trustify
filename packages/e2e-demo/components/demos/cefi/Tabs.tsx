            ...
            <Link key={tab.name} href={tab.href}>
              <a
                className={classNames(
                  ...
                  "group relative min-w-0 flex-1 overflow-hidden bg-gray-300 py-4 px-4 text-sm font-medium text-center hover:bg-gray-900 focus:z-10"
                )}
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className={classNames(
                    tab.current ? "bg-amber-300" : "bg-transparent",
